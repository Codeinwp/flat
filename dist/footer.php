...
?>
			<?php if ( apply_filters( 'show_flat_credits', true ) ) : ?>
				...
				<footer class="site-info" itemscope itemtype="http://schema.org/WPFooter">
					...
					<?php printf( esc_html__( 'Theme: %1$s %2$s by %3$s.', 'flat' ), 'Flat', wp_get_theme( get_template() )->get( 'Version' ), '<a href="' . esc_url( 'http://www.yoarts.com/blog/wordpress/free-flat-design-wordpress-theme.html' ).'" title="' . esc_attr__( 'Flat WordPress Theme' ).'">YoArts</a>' ); ?>
				</footer>
