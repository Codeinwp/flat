<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
  <header class="entry-header">
    ...
    <?php if ( flat_get_theme_option('archive_metadata') != 0 ) : ?>
      <div class="entry-meta"><?php flat_entry_meta(); ?></div>
    <?php endif; ?>
  </header>
  <?php if ( has_post_thumbnail() && ! post_password_required() && flat_get_theme_option('archive_featured_image') != 0 ) : ?>
  ...
  <?php endif; ?>
  <?php if ( is_search() || flat_get_theme_option('archive_content') == '0' ) : ?>
