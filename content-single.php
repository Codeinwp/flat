<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    ...
    <?php if (empty(flat_get_theme_option('single_metadata'))) : ?>
      <div class="entry-meta"><?php flat_entry_meta(); ?></div>
    <?php endif; ?>
	</header>

	<?php if ( has_post_thumbnail() && !post_password_required() && empty(flat_get_theme_option('single_featured_image'))) : ?>
...
<?php if ( get_the_author_meta( 'description' ) && empty(flat_get_theme_option('single_author_box')) : ?>
