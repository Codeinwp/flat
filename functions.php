...
function flat_scripts_styles() {
	...
	wp_enqueue_style( 'flat-template', get_template_directory_uri() . '/assets/css/template.css', array(), '1.2.12' );
	wp_enqueue_style( 'flat-style', get_stylesheet_uri(), array(), '1.2.12' );
